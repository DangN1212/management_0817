...
<div class="index container">
    <div class="row">
        <div class="col s3">
            ...
            <div class="box_btn">
                <a href="<?= base_url() ?>admin/invest" class="btn waves-effect waves-light iframe">Thêm</a>
            </div>
            <div class="box_btn">
                <a href="<?= base_url() ?>admin/invest" class="btn waves-effect waves-light iframe">Xem/Sửa</a>
            </div>
        </div>
        <div class="col s3">
            <h5 class="text_title">Số tiền thu nhập: <br><span><?= $totalIncome ?> vnđ</span></h5>
            <div class="box_btn">
                <a href="<?= base_url() ?>staff/add_income" class="btn waves-effect waves-light iframe">Thêm</a>
            </div>
            <div class="box_btn">
                <a href="<?= base_url() ?>staff/list_income" class="btn waves-effect waves-light iframe">Xem/Sửa</a>
            </div>
        </div>
        <div class="col s3">
            <h5 class="text_title">Số tiền chi tiêu: <br><span><?= $totalOutcome ?> vnđ</span></h5>
            <div class="box_btn">
                <a href="<?= base_url() ?>staff/add_outcome" class="btn waves-effect waves-light iframe">Thêm</a>
            </div>
            <div class="box_btn">
                <a href="<?= base_url() ?>staff/list_outcome" class="btn waves-effect waves-light iframe">Xem/Sửa</a>
            </div>
        </div>
        <div class="col s3">
